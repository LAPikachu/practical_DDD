...
In the first Task the required software is installed from the \href{http://zig.onera.fr/mm_home_page/}{microMegas Homepage}. The folder in which most work are done are \code{\textbackslash in} and \code{\textbackslash out}
